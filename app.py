...
탭 구성:
  ...
  ② 분석 프롬프트 생성 — 실험과 같은 형식의 프롬프트 생성·복사, 수집 지표 내려받기 (LLM 호출 없음)
...
#   · divider 상하 32px씩 64px — 마운트한 세 탭은 섹션 제목으로 구분하게 바꿔 이제
#     divider를 쓰지 않는다. 캡처용으로 남겨 둔 tab_report가 쓰므로 규칙은 둔다.
