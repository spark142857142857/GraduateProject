...
| ② 개별 종목 분석 | **KRX 상장 전 종목(약 2,870개)** 중 하나를 골라 오늘 기준 신호 생성. 신호 배지·투자 근거·재무지표(cond2+)·리포트(cond3+)·DART 실적(cond4)·해당 종목 백테스트 성과 | **호출** |
...
>
> **탭②의 대상은 백테스트 20종목이 아니라 KRX 상장 전 종목이다.** 백테스트와 forward는
