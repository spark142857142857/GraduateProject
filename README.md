...
| 탭 | 내용 | API |
|----|------|-----|
| ① 개별 종목 분석 | 종목·조건·모델 선택 후 오늘 기준 신호 생성. 신호 배지·투자 근거·재무지표(cond2+)·리포트(cond3+)·DART 실적(cond4)·해당 종목 백테스트 성과 | **호출** |
...
>
> 탭②는 forward 캐시가 아니라 백테스트 결과를 읽는다. forward는 신호 생성을 2026-08-02로
