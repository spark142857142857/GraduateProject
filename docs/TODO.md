...
- [x] **전 필드 audit 완료 (전 20종목, 전 필드, vs 네이버)**: 시총·매출·영업익·순익·영업이익률·부채비율·YoY 전부 오차 ~0%, PER TTM 후 정합(평균 3.5%). PBR·ROE만 정의차(연결자본 vs 지배주주). 배당수익률은 시차 있으나 LLM 컨텍스트 미포함으로 무영향. 상세: [experiments_log.md](experiments_log.md) "데이터 검증 & PER TTM 전환" 섹션.
