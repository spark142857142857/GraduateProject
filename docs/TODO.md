...
- [x] **전 필드 audit 완료 (10종목, vs 네이버)**: 시가총액·매출·영업익·순익 완벽 일치, PER은 TTM 전환 후 정합(±6%), PBR만 정의차(연결자본·연간시점)로 일부 종목 차이 → 현행 유지. 상세: [experiments_log.md](experiments_log.md) "데이터 검증 & PER TTM 전환" 섹션.
